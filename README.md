...
## 📬 Get in Touch  
📧 **Email**: xxiaojing0914@gmail.com  
🔗 **LinkedIn**: [linkedin.com/in/kayxu449911](https://www.linkedin.com/in/kayxu449911)  
💻 **GitHub**: [github.com/SWEOreO](https://github.com/SWEOreO) 
...
- **Tools**: NumPy, Pandas, VS Code, Postman, Docker, NPM, Yarn    
- **Other**: Agile methodologies, Unit testing, CI/CD  


## 🔧  Projects  

### [Efficio Task Tracker](https://github.com/fantastic4-efficio/efficio)  
*A web-based full-stack project built with JavaScript, React, and PostgreSQL.*  

### [Rock-Paper-Scissors Game](https://github.com/SWEOreO/Rock-Paper-Scissors)  
*Manual play & auto-play, real-time score tracking.*
